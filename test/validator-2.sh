...
V1SEED=0x3348e15287dae612d9c8f008a468ff6c229a55c4b58d778f389cc03134e3efbe
V1ADDR=5CmKswtRQGFrt3CcP5waJVxgEJfRy1xsmwPLRPWkumLBz8nv
...
mkdir -p ./output/validator2
chmod 700 ./output/validator2

echo "🔑 Inserting session keys (babe, grandpa, im_online, authority_discovery)..."
$NODE_BIN key insert --base-path ./output/validator2 --chain ./output/local-chain-spec-raw-2.json \
...
echo
echo "🚀 Starting Validator Node (logs -> ./output/validator2.log)..."
exec $NODE_BIN \
  --base-path ./output/validator2 \
