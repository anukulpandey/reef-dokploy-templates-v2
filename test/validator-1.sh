...
V1SEED=0x4beb11e380012110b0b072fbb3d8e7455921cf4658de06c33d970be82ccf9ed5
...
mkdir -p ./output/validator1
chmod 700 ./output/validator1

echo "🔑 Inserting session keys (babe, grandpa, im_online, authority_discovery)..."
$NODE_BIN key insert --base-path ./output/validator1 --chain ./output/local-chain-spec-raw-2.json \
...
echo
echo "🚀 Starting Validator Node (logs -> ./output/validator1.log)..."
exec $NODE_BIN \
  --base-path ./output/validator1 \
